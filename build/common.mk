...
OPTEE_GET_CRL_PATH		?= $(ROOT)/optee_get_crl
OPTEE_PIC_SERVER_PATH		?= $(ROOT)/optee_pic_server
OPTEE_DARKNETZ_PATH		?= $(ROOT)/optee_darknetz
APPARMOR_PATH			?= $(ROOT)/apparmor
...
BR2_PACKAGE_OPTEE_GET_CRL ?= y
BR2_PACKAGE_OPTEE_GET_CRL_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
BR2_PACKAGE_OPTEE_GET_CRL_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_OPTEE_GET_CRL_SITE ?= $(OPTEE_GET_CRL_PATH)
BR2_PACKAGE_OPTEE_PIC_SERVER ?= y
BR2_PACKAGE_OPTEE_PIC_SERVER_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
BR2_PACKAGE_OPTEE_PIC_SERVER_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_OPTEE_PIC_SERVER_SITE ?= $(OPTEE_PIC_SERVER_PATH)
BR2_PACKAGE_OPTEE_DARKNETZ ?= y
BR2_PACKAGE_OPTEE_DARKNETZ_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
BR2_PACKAGE_OPTEE_DARKNETZ_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_OPTEE_DARKNETZ_SITE ?= $(OPTEE_DARKNETZ_PATH)
# Security
...
BR2_PACKAGE_PYTHON3_PYCRYPTODOMEX=y
